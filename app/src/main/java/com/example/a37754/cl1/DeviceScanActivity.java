...
public class DeviceScanActivity extends ListActivity {
	...
	private com.example.a37754.cl1.LeDeviceListAdapter mLeDeviceListAdapter = null;
	// 搜索BLE终端
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Toast toast = Toast.makeText(getApplicationContext(), "正在连接设备并获取服务",
				Toast.LENGTH_LONG);
	...
	private BluetoothLeClass.OnDataAvailableListener mOnDataAvailable = new BluetoothLeClass.OnDataAvailableListener() {
		...
		public void onCharacteristicRead(BluetoothGatt gatt,
			...
			ColorLight.char6_display(Utils.bytesToString(characteristic
	...
	private void displayGattServices(List<BluetoothGattService> gattServices) {
		...
		intent.setClass(DeviceScanActivity.this, ColorLight.class);
